#  'Field' é usado para definir campos dentro desses modelos.
#  'ULID' é uma abreviação de "Universally Unique Lexicographically Sortable Identifier", e é usado para gerar identificadores únicos.
